...
return [
    ...
    //
    // 'controllers' => [
    //     'query' => '\BonfireCC\GraphQL\GraphQLController@query',
    //     'mutation' => '\BonfireCC\GraphQL\GraphQLController@mutation'
    // ]
    //
    'controllers' => \BonfireCC\GraphQL\GraphQLController::class . '@query',
    ...
    //
    'types' => [
        'PageInfo'           => BonfireCC\GraphQL\Support\PageInfo::class,
    ],
    ...
    //     'locations' => []
    // ]
    'error_formatter' => ['\BonfireCC\GraphQL\GraphQL', 'formatError'],
    ...
    'graphiql' => [
        ...
        'controller' => \BonfireCC\GraphQL\GraphQLController::class.'@graphiql',
        'middleware' => [],
